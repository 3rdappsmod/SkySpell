...
Node.js 24 LTS를 권장합니다(`.nvmrc`, 22.x는 22.13 이상, 또는 24 이상). 설치된 앱을 사용할 때는 Node.js가 필요 없습니다.
...
미저장 변경 사항은 새 문서·지우기·파일 열기·종료 시 버리기 확인을 받습니다. 저장 취소/실패 시에는 미저장 상태가 유지됩니다. 검사 진행 건수를 표시하며, 검사 취소 버튼 또는 원문 변경으로 요청을 중단할 수 있습니다.
